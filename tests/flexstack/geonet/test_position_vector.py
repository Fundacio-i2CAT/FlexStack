...
class TestTST(unittest.TestCase):
    def test_set_in_normal_timestamp_seconds(self):
        ...
        self.assertEqual(tst.msec, 430857560)
    ...
    def test_encode(self):
        tst = TST()
        tst.set_in_normal_timestamp_seconds(1674637884)
        self.assertEqual(tst.encode(), 430857560)
...
class TestLongPositionVector(unittest.TestCase):
    ...
    def test_encode(self):
        ...
        ), b'\x88\x00\xaa\xbb\xcc\x11"3\x19\xbd*h\x1fM\xea\xd0\x07\xfdo\x04\x80\x00\x00\x00')
...
class TestShortPositionVector(unittest.TestCase):
    def test_encode(self):
        ...
        ), b'\x88\x00\xaa\xbb\xcc\x11"3\x19\xbd*h\x1fM\xea\xd0\x07\xfdo\x04')
