...
from src.flexstack.facilities.ca_basic_service.ca_basic_service import CooperativeAwarenessBasicService
from src.flexstack.facilities.ca_basic_service.ca_basic_service import VehicleData
...
def configure_v2x(station_id: int, log_level: str) -> None | Exception:
    ...
    ca_basic_service = CooperativeAwarenessBasicService(
        btp_router=btp_router, vehicle_data=vehicle_data, ldm=local_dynamic_map
    )
